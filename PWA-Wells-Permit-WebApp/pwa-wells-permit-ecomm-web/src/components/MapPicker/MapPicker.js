...
function MapPicker({
  ...
  // the map (e.g. coordinates preset from the project site selected on the first
  // screen, or typed into the lat/long inputs). Recenters only when the marker
  // first appears so dragging the pin doesn't cause a jarring re-center.
  useEffect(() => {
